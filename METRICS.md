...
> Last updated: **2026-05-08 07:02 UTC**  
...
| Component | Status |
|-----------|--------|
| Post generation | **STALLED** — backlog throttle (70 stale drafts), historical bad-batch archived (37 posts, decaying) |
...
- Explicit user feedback: **323** comments, **357** ratings, avg **1.0 / 5**
- Implicit signals (automated): **104** (posts auto-marked after 72h no feedback or 7d stale)
- Combined total: **427** feedback entries
