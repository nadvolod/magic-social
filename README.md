...
> Last updated: **2026-05-28 08:19 UTC**  
> Auto-generated by `python -m src.agent metrics`
...
| Component | Status |
|-----------|--------|
| Post generation | **STALLED** — backlog throttle (25 stale drafts) |
...
- Explicit user feedback: **327** comments, **327** ratings, avg **1.1 / 5**
- Implicit signals (automated): **36** (posts auto-marked after 72h no feedback or 7d stale)
- Combined total: **363** feedback entries
