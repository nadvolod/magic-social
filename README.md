...
> Last updated: **2026-07-12 07:19 UTC**  
> Auto-generated by `python -m src.agent metrics`
...
| Component | Status |
|-----------|--------|
| Post generation | **STALLED** — backlog throttle (26 stale drafts) |
...
- Screenshots processed: **13**
- Top 10% examples: **3**
- Bottom 90% examples: **10**
...
- Explicit user feedback: **354** comments, **354** ratings, avg **1.1 / 5**
- Implicit signals (automated): **37** (posts auto-marked after 72h no feedback or 7d stale)
- Combined total: **391** feedback entries
