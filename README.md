...
**Your real LinkedIn posts are the gold standard.** If a generated post doesn't match the quality and style of what you normally publish, it's a fail.

---

## Objective

**Get 3 AI-generated posts published on LinkedIn.** Then learn and grow from there.

| Milestone | Status |
|-----------|--------|
| Generate posts that match your style | In progress |
| Get 1st post published | Not yet |
| Get 3 posts published | Not yet |
| Learning loop active (weights adjusting) | Waiting for published post analytics |
...
**[Full Dashboard → METRICS.md](METRICS.md)** | **[Health Check → `python -m src.agent health-check`]**
...
**If a generated post wouldn't fit alongside your real posts, it shouldn't be published.**
